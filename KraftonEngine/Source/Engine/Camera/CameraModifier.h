...
// UCameraModifier 대응 — 카메라 view를 후처리로 변형하는 추상 베이스
// PCM 또는 카메라 컴포넌트가 modifier list를 들고 매 프레임 ModifyCamera를 순회 호출
...
public:
	...
	// view를 in-place로 변형 true 반환 시 이후 modifier 체인 중단(ModifyCamera 반환값과 동일 의도)
